...
var addNewNoteButton = document.querySelector('#btn-add');
var noteModal = document.querySelector('#add-note-modal');
var closeBtnModal = document.querySelector('#modal-title .close');
var addBtnModal = document.querySelector('#add-btn');
var editBtnModal = document.querySelector('#edit-btn');
...
var createNotes = function createNotes(notes, list) {
  if (list) {
...
var createNote = function createNote(note, index) {
...
searchInput.addEventListener('keyup', function (event) {
  ...
  var notesToSearch = [].concat(_toConsumableArray(notes));
...
deleteBtnModal.addEventListener('click', function (e) {
  var prevNotes = [].concat(_toConsumableArray(notes));
...
editBtnModal.addEventListener('click', function (event) {
  var noteTitle = titleInput.value;
  var noteContent = contentInput.value;
  var noteCircle = notes[currentNoteID].tag;
  // const newNote = { title: noteTitle, content: noteContent, tag: noteCircle }
  var newNote = new Note(noteTitle, noteContent, noteCircle);
  var editedNote = [].concat(_toConsumableArray(notes));
...
addNewNoteButton.addEventListener('click', function (event) {
  noteModal.style.display = 'block';
...
addBtnModal.addEventListener('click', function () {
  ...
  var newNote = new Note(noteTitle, noteContent, circles[randomCircle]);
  notes.push(newNote);
